...
default_choices =["Kyllä", "Ei", "Ehkä" , "Öööö.." , "Hmm.." , "Mjaa.." , "..." , "En osaa vastata tuohon"]
...
when_choices =["Viimeksi joulukuussa" , "Sitten kun anps voi hyvin" , "Ei vittu ikinä" , "Aikavälillä 10,000ekr - 2017"]
...
whatlike_choices =["Ruosteinen" , "Paskainen" , "Jostain syystä omituisen hyväntuoksuinen" , "Jännä" , "Pullea" , "Söpö"]
