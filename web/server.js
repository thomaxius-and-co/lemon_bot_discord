...
const buildInitialState = req => {
  ...
  case '/':
    ...
    return Promise.join(
      ...
      (messageCountByUser, userMessages, botMessages, messagesInLastWeek, messagesInLastMonth, spammer, dailyMessageCounts, rolling7DayMessageCounts, messagesPerWeekday7, messagesPerWeekday30, messagesPerWeekday90, messagesPerWeekday360) => ({
        user: req.user,
        messageCountByUser,
        userMessages,
        botMessages,
